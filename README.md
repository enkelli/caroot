...
```
# Runs some default automaton (GUI, if tkinter is installed).
./cartist.py

# Runs automaton with the given rule set and computes square root of 36 (requires `tkinger`).
./cartist.py -r rule_sets/sq-4-11 36

# CLI version of the above.
./cartist.py -r rule_sets/sq-4-11 -c 16
